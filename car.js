planck.testbed('Car', function(testbed) {
    ...
    ground.createFixture(pl.Edge(Vec2(x, 0.0), Vec2(x + 40.0, 0.0)), groundFD); //underbridge flat
    ...
    world.createJoint(pl.RevoluteJoint({}, prevBody, ground, Vec2(160.0 + 2.0 * i, -0.125))); //tether for bridge
